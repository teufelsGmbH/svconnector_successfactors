...
task. The first step is to get the proper service object with the desired parameters:
...
extending the :php:`\Cobweb\SvconnectorSuccessfactors\Paginator\AbstractPaginator` class.
...
The existing :php:`\Cobweb\SvconnectorSuccessfactors\Paginator\HydraPaginator` is obviously a good
